...
import 'package:choriapp/src/pages/client/products/list/client_products_list_controller.dart';
import 'package:choriapp/src/utils/my_colors.dart';
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:choriapp/src/models/category.dart';
import 'package:choriapp/src/widgets/no_data_widget.dart';
  ...
  Widget _menuDrawer() {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Image.asset('assets/img/menu_black.png', width: 20, height: 20),
      ),
    );
  }
